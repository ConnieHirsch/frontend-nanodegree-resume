...
var HTMLblog = "<li class='flex-item'><span class='orange-text'>%icon% blog</span><span class='white-text'>%data%</span></li>";
...
var HTMLskills = "<li class='flex-item hvr-float'><span class='white-text'>%data%</span></li>";
